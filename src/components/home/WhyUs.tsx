...
const WhyUs = () => {
  const features = [
    {
      icon: Flame,
      title: 'Hot Pressure Washing',
      description: 'Better results for tough stains',
    },
    {
      icon: Home,
      title: 'Small to Large',
      description: 'Capable of small homes to large commercial properties',
    },
    {
      icon: Wrench,
      title: 'Professional Equipment',
      description: 'Professional commercial-grade equipment',
    },
    {
      icon: Building2,
      title: 'Specialists',
      description: 'Residential, commercial & strata specialists',
    },
    {
      icon: ShieldCheck,
      title: 'Reliable & Insured',
      description: 'Reliable, insured and detail-oriented',
    },
    {
      icon: Phone,
      title: 'One Call',
      description: 'One call for complete property care',
    },
  ];
